...
if __name__ == "__main__":
    ...
    train_dataset = Dataset(img_names_train, captions_train, transform=transform)
    ...
    val_dataset = Dataset(img_names_val, captions_val, transform=transform)
    ...
    test_dataset = Dataset(img_names_test, captions_test, transform=transform)
    ...
    best_loss_val = 9999
    log=[]
    for epoch in tqdm(config.num_epochs+1):
